...
class OrdersWidget implements WidgetModuleInterface
{
    ...
    {
        $html = '<div style="padding:12px 16px;border-bottom:1px solid var(--pn-border);font-size:13px;">'.e(__('admin.dashboard.pending_label')).': <b style="color:#f89406;">'.e($data["pending"]).'</b></div>';
