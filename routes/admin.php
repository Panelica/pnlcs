...
Route::middleware(["admin.auth"])->prefix("admin")->name("admin.")->group(function () {
    ...
    Route::middleware("admin.permission:view_reports")->group(function () {
        ...
        Route::get("reports/{slug}/export", [\App\Http\Controllers\Admin\ReportController::class, "export"])->name("reports.export");
    });
    ...
    // SSL Orders
    Route::middleware("admin.permission:list_services")->group(function () {
        Route::get("ssl-orders", [\App\Http\Controllers\Admin\SslOrderController::class, "index"])->name("ssl.index");
    });
    Route::middleware("admin.permission:view_services")->group(function () {
        Route::get("ssl-orders/{sslOrder}", [\App\Http\Controllers\Admin\SslOrderController::class, "show"])->name("ssl.show");
        Route::get("ssl-orders/{sslOrder}/download", [\App\Http\Controllers\Admin\SslOrderController::class, "downloadCert"])->name("ssl.download");
    });
    Route::middleware("admin.permission:manage_services")->group(function () {
        Route::post("ssl-orders/{sslOrder}/action", [\App\Http\Controllers\Admin\SslOrderController::class, "moduleAction"])->name("ssl.action");
    });
});
