        ...
        <table class="pn-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-muted text-sm">{{ $quote->date ? \Carbon\Carbon::parse($quote->date)->format('d M Y') : '-' }}</td>
                    <td class="text-muted text-sm">{{ $quote->valid_until ? \Carbon\Carbon::parse($quote->valid_until)->format('d M Y') : '-' }}</td>
