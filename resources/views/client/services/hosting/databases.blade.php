...
<style>
    ...
    .db-pop{position:absolute;right:0;z-index:20;margin-top:6px;background:var(--card);border:1px solid var(--border);border-radius:11px;padding:14px;box-shadow:var(--shadow-md);min-width:250px;text-align:left}
