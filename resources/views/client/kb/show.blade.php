...
<div class="kb-wrap">
    ...
    <div class="kb-header">
        ...
        <div class="kb-meta">
            ...
            <span class="kb-meta-date">
                ...
                {{ $article->updated_at->format(date_fmt()) }}
            </span>
        </div>
    </div>
    ...
    <div class="kb-helpful">
        ...
        <div class="kb-helpful-btns">
            <button class="kb-helpful-btn" onclick="this.classList.add('selected');this.innerHTML='&#128077; {{ __('client.kb.thanks') }}';this.disabled=true;this.nextElementSibling.disabled=true">&#128077; {{ __('client.kb.yes') }}</button>
            <button class="kb-helpful-btn" onclick="this.classList.add('selected');this.innerHTML='&#128078; {{ __('client.kb.noted') }}';this.disabled=true;this.previousElementSibling.disabled=true">&#128078; {{ __('client.kb.no') }}</button>
        </div>
    </div>
