...
<tr><td style="padding:8px;border-bottom:1px solid #eee;"><strong>{{ __('email.invoice_paid.payment_date') }}</strong></td><td style="padding:8px;border-bottom:1px solid #eee;">{{ $invoice->paid_at?->format('M d, Y') ?? now()->format('M d, Y') }}</td></tr>
</table>
