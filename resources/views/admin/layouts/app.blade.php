...
<div class="flex h-screen overflow-hidden">
    <aside x-show="sidebarOpen" class="fixed inset-y-0 left-0 z-30 w-64 bg-gradient-to-b from-indigo-950 via-slate-900 to-slate-950 shadow-2xl lg:relative flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="{{ route("admin.products.index") }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs("admin.products.*") ? "bg-indigo-600/30 text-white" : "text-slate-300 hover:bg-white/5 hover:text-white" }} transition-all"><x-heroicon-o-server-stack class="w-5 h-5 shrink-0" /><span>Products/Services</span></a>
            ...
            <a href="{{ route("admin.reports.index") }}" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium {{ request()->routeIs("admin.reports.*") ? "bg-indigo-600/30 text-white" : "text-slate-300 hover:bg-white/5 hover:text-white" }} transition-all"><x-heroicon-o-chart-bar class="w-5 h-5 shrink-0" /><span>Reports</span></a>
