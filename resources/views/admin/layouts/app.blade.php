...
<div class="flex h-screen overflow-hidden">
    <aside x-show="sidebarOpen" class="fixed inset-y-0 left-0 z-30 w-64 bg-gradient-to-b from-indigo-950 via-slate-900 to-slate-950 shadow-2xl lg:relative flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-users class="w-5 h-5 shrink-0" /><span>Clients</span></a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-shopping-cart class="w-5 h-5 shrink-0" /><span>Orders</span></a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-credit-card class="w-5 h-5 shrink-0" /><span>Billing</span></a>
            <div class="pt-4"><p class="px-3 text-xs font-semibold text-indigo-300/60 uppercase tracking-wider">Services</p></div>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-server-stack class="w-5 h-5 shrink-0" /><span>Products/Services</span></a>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-globe-alt class="w-5 h-5 shrink-0" /><span>Domains</span></a>
            <div class="pt-4"><p class="px-3 text-xs font-semibold text-indigo-300/60 uppercase tracking-wider">Support</p></div>
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-ticket class="w-5 h-5 shrink-0" /><span>Support Tickets</span></a>
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-slate-300 hover:bg-white/5 hover:text-white transition-all"><x-heroicon-o-cog-6-tooth class="w-5 h-5 shrink-0" /><span>Settings</span></a>
