            ...
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 15px;">
                ...
                <div class="form-group"><label class="form-label">{{ __('admin.clients.billing_type') }}</label>
                    <select name="client_type" class="form-control">
                        <option value="">-</option>
                        <option value="individual" {{ old('client_type') === 'individual' ? 'selected' : '' }}>{{ __('admin.clients.billing_type_individual') }}</option>
                        <option value="company" {{ old('client_type') === 'company' ? 'selected' : '' }}>{{ __('admin.clients.billing_type_company') }}</option>
                    </select>
                </div>
                <div class="form-group"><label class="form-label">{{ __('admin.clients.billing_tax_office') }}</label><input type="text" name="tax_office" value="{{ old('tax_office') }}" maxlength="100" class="form-control"></div>
                <div class="form-group"><label class="form-label">{{ __('admin.clients.billing_national_id') }}</label><input type="text" name="national_id" value="{{ old('national_id') }}" maxlength="20" class="form-control"></div>
