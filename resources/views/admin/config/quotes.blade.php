...
<div class="page-header" style="display:flex;align-items:center;justify-content:space-between;">
    <h1>Quotes</h1>
    <a href="{{ route('admin.config.quotes.create') }}" class="btn btn-primary btn-sm">+ New Quote</a>
</div>
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <td style="text-align:right;">
                <a href="{{ route('admin.config.quotes.edit', $quote) }}" class="btn btn-default btn-xs">Edit</a>
                <form method="POST" action="{{ route('admin.config.quotes.destroy', $quote) }}" style="display:inline;" onsubmit="return confirm('Delete this quote?')">
                    @csrf @method('DELETE')
