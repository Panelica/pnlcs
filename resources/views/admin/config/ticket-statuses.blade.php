        ...
        <tr>
            ...
            <td style="text-align:right;">
                <button type="button" class="btn btn-default btn-xs"
                    onclick="openEditTS({{ json_encode(['id'=>$status->id,'title'=>$status->title,'color'=>$status->color,'show_active'=>$status->show_active,'sort_order'=>$status->sort_order]) }})">{{ __('common.actions.edit') }}</button>
