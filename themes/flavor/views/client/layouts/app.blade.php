...
<head>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0}
        :root{
            --primary:var(--theme-primary, #ea580c);
            --primary-light:var(--theme-primary-light, #fff7ed);
            --primary-dark:var(--theme-primary-dark, #c2410c);
        ...
        body{font-family:'Plus Jakarta Sans','Inter',-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,sans-serif;font-size:14px;background:var(--bg);color:var(--text);line-height:1.5;-webkit-font-smoothing:antialiased}
...
{{-- Dark mode variables for Flavor client layout --}}
<style>
:root[data-theme="dark"] {
    --bg:#0f172a !important; --card:#1e293b !important; --border:#334155 !important;
    --text:#e2e8f0 !important; --muted:#94a3b8 !important;
}
:root[data-theme="dark"] body { background:#0f172a !important; color:#e2e8f0 !important; }
