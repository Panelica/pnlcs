...
{
    public function create(Service $service): array { return ["success" => true, "message" => "Service created manually"]; }
    public function suspend(Service $service, string $reason = ""): array { return ["success" => true]; }
    ...
    public function getModuleName(): string { return "Custom/No Module"; }
}
