...
API access may be broken. While the balance cannot be read, no low-balance warning can be raised either.',
    ...
    'iyzico' => [
        ...
        // Unattended charging of a stored card. Shown to an operator on the
        // invoice page when a charge is left for a person to look at.
        'autocharge' => [
            'no_card_form' => 'iyzico cannot store a card on its own; a card is kept when a customer pays an invoice and asks for it to be saved.',
            'card_not_saved' => 'The customer did not ask for this card to be saved.',
            'not_your_payment' => 'That payment does not belong to this account.',
            'not_an_iyzico_card' => 'That payment method was not stored with iyzico.',
            'nothing_to_detach' => 'There is no stored card for iyzico to let go of.',
            'incomplete_keys' => 'This stored card cannot be deleted from here: the row does not carry the iyzico user key that has to be sent beside the card token. Remove it in iyzico\'s own dashboard.',
            'detached' => 'The stored card was deleted at iyzico.',
            'already_gone' => 'iyzico is no longer holding that card.',
            'wrong_client' => 'The stored card belongs to a different client than this invoice.',
            'card_removed' => 'The customer has removed this stored card.',
            'card_needs_update' => 'This stored card needs the customer to update it.',
            'no_stored_keys' => 'This stored card is missing the keys iyzico needs to charge it.',
            'no_reference' => 'No reference was supplied to send this charge under, and iyzico cannot be asked about a charge that has no reference.',
            'no_try_rate' => 'No Turkish lira rate is set, so this invoice cannot be converted for iyzico.',
            'no_answer' => 'iyzico did not say whether the charge went through.',
            'needs_cardholder' => 'iyzico asked for the cardholder to authenticate this payment, so nothing was taken.',
            'no_payment_id' => 'iyzico reported a payment without naming it, so it could not be recorded.',
            'inquiry_unanswered' => 'iyzico could not be asked what became of the charge already sent.',
            'inquiry_unfinished' => 'iyzico has the payment but has not finished it (status: :status).',
            'inquiry_not_found' => 'iyzico has no record of the charge under this reference yet, which is not proof that it never arrived.',
            'inquiry_refused' => 'iyzico refused the question about the charge already sent.',
            'traced_refusal' => 'iyzico confirmed the charge already sent was refused.',
            'account_not_permitted' => 'iyzico will not let this account take this payment. Unattended card charges need NON-3DS enabled on the merchant account; ask iyzico to switch it on at entegrasyon@iyzico.com.',
            'bank_unresolved' => 'The bank exchange did not complete, so whether the card was charged is not established.',
            'token_gone' => 'iyzico is no longer holding this stored card, so the customer has to store it again.',
            'still_unknown' => 'Nothing was sent this time, so what became of the charge already sent is still unknown.',
        ],
    ],
